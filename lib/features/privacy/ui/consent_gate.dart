...
/// Zeigt beim ersten Start einen Datenschutz-Hinweis, bis er bestaetigt ist.
///
/// Sitzt (wie das App-Schloss) im `builder` der MaterialApp und umschliesst die
/// gesamte App. Bewusst schlicht und blockierend: erst nach Bestaetigung geht
/// es weiter.
class ConsentGate extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return _ConsentScreen(
      onAccept: () async {
        await ref.read(appSettingsProvider.notifier).setPrivacyAccepted(true);
        ...
        await ref
            ...
            .log(
              ...
              entityType: 'consent',
              action: 'accept',
              summary: 'Datenschutz-Hinweis beim ersten Start bestaetigt',
            );
      },
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _Point(
                    ...
                    text:
                        'Die App laeuft offline. Ohne Konto bleiben alle Daten '
                        'auf diesem Geraet.',
                  ),
                  const _Point(
