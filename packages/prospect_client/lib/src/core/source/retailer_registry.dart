...
class RetailerRegistry {
  ...
  static const Map<String, String> _canonicalByName = {
    ...
    'hit markt': 'hit',
    'ikea': 'ikea',
    // JYSK hiess in Deutschland bis 2021 Daenisches Bettenlager, aeltere
    // Datenbestaende der Quellen nutzen den Namen teils noch.
    'jysk': 'jysk',
    'daenisches bettenlager': 'jysk',
    'kaufland': 'kaufland',
    'kik': 'kik',
    'kik textilien': 'kik',
    'kik textilien und non food': 'kik',
    'lidl': 'lidl',
