...
-- =========================================================================
-- Tabellen-Berechtigungen fuer die angemeldete Rolle
-- =========================================================================
--
-- RLS regelt WELCHE Zeilen sichtbar sind, aber die Rolle 'authenticated'
-- braucht zusaetzlich die Tabellen-Rechte, um ueberhaupt zugreifen zu duerfen.
-- Geschrieben wird nur ueber die SECURITY-DEFINER-Funktionen, daher genuegt
-- SELECT fuer den Client.
